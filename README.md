...
## **Будущие обновления**
[v1.0.1]
[-] Переход с Framework 4.7.2 на .NET 6.0 (долой много файлов);
[-] Исправление неработающих кнопок помощи;
[-] Отработка действий программы при отсутствии интернета;
...
>>>>>>> da91cac3aec4ae2d92893566fd7e1f8fc38db0ea
