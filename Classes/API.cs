...
namespace RemoveComVK.Classes
{
    public class API
    {
        ...
        async public static Task<bool> setKey(string key)
        {
            ...
            try
            {
                resp = await httpClient.PostAsync("https://api.vk.com/method/account.getAppPermissions", opt);
            }
            catch (Exception ex)
            {
        ...
        async public static Task<bool> initProfile()
        {
            ...
            try
            {
                resp = await httpClient.PostAsync("https://api.vk.com/method/account.getProfileInfo", opt);
            }
        ...
        async public static Task<bool> sendDeleteComm(string owner_id, string comment_id)
        {
            ...
            try
            {
                resp = await httpClient.PostAsync("https://api.vk.com/method/wall.deleteComment", opt);
            }
